    ...
    <div class="container">
        <div class="card mb-4 w-50">
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('petugas.update', ['id' => $petugas->idPetugas]) }}"
                    method="post">
                    @csrf
                    @method('put')
                    {{-- <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="inputAddress" value="{{ $petugas->namaPetugas }}" placeholder="Rafinia Wijaya"
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" name="alamat_petugas"
                            placeholder="Royal Extension X, Jakarta" value="{{ $petugas->alamatPetugas }}">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" name="telepon_petugas" id="inputAddress2"
                            placeholder="089672651777" value="{{ $petugas->teleponPetugas }}">
                    </div>
                    {{-- <div class="col-md-6">
