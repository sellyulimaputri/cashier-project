...
@section('section')
    <div class="container">
        <div class="card mb-4 w-50">
            <div class="card-body">
                <h6>Update Koleksi</h6>
                <form class="row g-3" action="{{ route('galeri.update', ['id' => $galeri->idGaleri]) }}" method="post"
            ...
            <div class="col-12">
                <div class="form-check">
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn bg-gradient-primary">Update Koleksi</button>
                    </div>
                </form>
            </div>
        </div>
